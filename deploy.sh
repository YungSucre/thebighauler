...
sleep 90
CODE=$(curl -s -o /dev/null -w "%{http_code}" --max-time 20 "https://thebighauler.pages.dev")
echo "pages.dev: $CODE"
CODE2=$(curl -s -o /dev/null -w "%{http_code}" --max-time 20 "https://thebighauler.com")
echo "domaine: $CODE2"
echo "=== 5. Sitemap ==="
curl -s --max-time 15 "https://thebighauler.com/sitemap-0.xml" | grep -c "<loc>" || echo "sitemap à vérifier"
echo "DONE"
